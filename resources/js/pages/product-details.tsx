                        ...
                        <div className="flex space-x-4 px-4 overflow-auto pb-2">
                            {product.images.map((image, index) => (
                                <button
                                    ...
                                    className={`relative h-20 w-20 flex-shrink-0 overflow-hidden rounded-lg ${selectedImage === index
                                ...
                                <div className="mt-2 flex space-x-3">
                                    {product.colors.map((color, index) => (
                                        <button
                                            ...
                                            className={`relative h-10 w-10 rounded-full ${selectedColor === index
                                ...
                                <div className="mt-2 flex flex-wrap gap-2">
                                    {product.sizes.map((size, index) => (
                                        <button
                                            ...
                                            className={`flex items-center justify-center rounded-md border px-4 py-2 text-sm font-medium ${selectedSize === index
